...
\begin{table}[t]
    \centering
    \small
    \caption{Comparison of approaches for institutional memory. ALFM is the only solution that simultaneously offers rapid updates, negative feedback (learning from mistakes), and strict tenant isolation without retraining the backbone.}
\resizebox{\columnwidth}{!}{
    \begin{tabular}{l c c c c}
        \toprule
        \textbf{Feature} & \textbf{RAG} & \textbf{Fine-Tuning} & \textbf{Long Context} & \textbf{ALFM} \\
        \midrule
        \textbf{Update Speed} & Instant & Slow (Retrain) & Instant & \textbf{Instant} \\
        \textbf{Failure Correction} & Weak & High & Medium & \textbf{High} \\
        \textbf{Tenant Isolation} & Logical & Hard (Separate) & Logical & \textbf{Crypto-Hard} \\
