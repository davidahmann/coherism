...
\begin{table}[t]
\centering
\caption{Ablation: BEM components vs. simpler baselines (Mean $\pm$ Std over 5 seeds). Note: RAG and NEP have no success retrieval capability by design.}
\label{tab:ablation}
\begin{tabular}{lcccc}
\toprule
...
BEM (ours) & 0.59 \small{$\pm$ 0.03} & \textbf{0.70} \small{$\pm$ 0.00} & 0.99 \small{$\pm$ 0.00} & 0.96 \small{$\pm$ 0.01} \\
\bottomrule
\end{tabular}
\end{table}
