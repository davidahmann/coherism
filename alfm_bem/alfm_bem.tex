...
\textbf{Memory pruning.} We implement time-based vacuuming: experiences older than a configurable TTL (default: 90 days) without re-confirmation are archived. High-weight experiences (frequently retrieved, strongly confirmed) are retained indefinitely. Pruning runs during maintenance windows.
