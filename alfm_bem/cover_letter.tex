...
\begin{itemize}
    ...
    \item \textbf{Empirical Validation}: Experiments on both synthetic data and real-world 20Newsgroups text embeddings demonstrate that BEM significantly improves failure retrieval (Precision \textbf{0.95} vs 0.73 for raw embeddings) and uniquely provides success pattern guidance that RAG baselines cannot offer.
\end{itemize}
