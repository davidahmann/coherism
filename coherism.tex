...
\begin{figure}[t]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Numerical simulation of the Coherist Wave Equation. The blue dashed line shows the constant energy of a standard harmonic oscillator. The red solid line shows the energy decay due to the informational friction term $\kappa \Theta_{00} \dot{\phi}$, demonstrating the ``friction of geometry'' acting on coherent states.}
...
This leads to small deviations from a pure cosmological constant, e.g.\ an equation of state $w(a) = -1 + w_a (1-a)$ is a phenomenological equation of state parameterizing the deviation from $\Lambda$CDM.
...
While heuristic, this suggests that the ``dark energy'' density is not constant but evolves as the universe thermalizes.
and a modified growth index $\gamma = 0.55+\delta\gamma$.
...
% ----------------------------------------------------------------------
\section{Derivation of \texorpdfstring{$\Theta_{\mu\nu}$}{Theta}}
\label{appendix:theta}
% ----------------------------------------------------------------------

In this appendix we outline the formal variation of the coherence functional with respect to the metric $g_{\mu\nu}$ and state $\rho$.
